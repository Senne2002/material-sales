  ...
  function (Device, Sorter, Fragment, Filter) {
    ...
    return {
      handleSortButtonPressed: function (oController, sFragment) {
        this.getViewSettingsDialog(sFragment, oController).then(function (
          oViewSettingsDialog
        ) {
