		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Material and sales application",
									"targetURL": "#apmaterialsales-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"apmaterialsales-display": {
								"semanticObject": "apmaterialsales",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ap.materialsales",
									"url": sap.ui.require.toUrl("ap/materialsales")
								}
							}
						}
					}
